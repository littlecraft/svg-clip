...
exports.description = 'Partially optimizes path, preserving absolute coordinates, applies transformations';

exports.overrides = ['convertPathData'];
...
exports.fn = function(item, params) {
    ...
    if (item.isElem(pathElems) && item.hasAttr('d')) {
        ...
        if (data.length) {
            ...
            if (params.utilizeAbsolute || !params.convertRelative) {
